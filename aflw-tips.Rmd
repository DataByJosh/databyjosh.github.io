...
tipstable <- read_xlsx("aflwtips.xlsx")
...
stable <- reactable(
  sumtable,
  columns = list(
    games = sum_col(name = "96"),
    xtips = sum_col(name = "69.5"),
    atips = sum_col(name = "60"),
    accuracy = sum_col(name = "62.5%"),
    mae = sum_col(name = "19.48"),
    bits = sum_col(name = "10.82")
  ),
  borderless = TRUE,
  sortable = FALSE,
...
<details>
<summary>**What about past years?**</summary>
The model has been in operation since AFLW Season 2022-A. [Click here for tips from past seasons.](https://www.databyjosh.com/past-aflw-tips)
</details>
